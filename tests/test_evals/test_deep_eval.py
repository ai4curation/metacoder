...
from deepeval.metrics import AnswerRelevancyMetric, FaithfulnessMetric, HallucinationMetric, SummarizationMetric
...
def test_generic_eval(metric_cls):
    ...
    test_case = LLMTestCase(
        ...
        context=["Title: From nocturnal frontal lobe epilepsy to Sleep-Related Hypermotor Epilepsy."],
        retrieval_context=["PMID:28027860? Title: From nocturnal frontal lobe epilepsy to Sleep-Related Hypermotor Epilepsy."]
    )
...
def test_hallucination_eval(metric_cls):
    ...
    test_case = LLMTestCase(
        ...
        context=["Title of PMID:28027860: From nocturnal frontal lobe epilepsy to Sleep-Related Hypermotor Epilepsy."]
    )
    results = evaluate([test_case], [metric])
    import yaml
    print(results)
