...
class MCPConfig(BaseModel):
    ...
    command: str | None = Field(None, description="Command to run the MCP (e.g. npx, uvx)")
...
class MCPCollectionConfig(BaseModel):
    ...
    description: str | None = Field(None, description="Description of the MCP collection")
    servers: list[MCPConfig] = Field(..., description="Servers to use for the MCP collection")
